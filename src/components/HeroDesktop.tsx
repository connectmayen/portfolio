...
// Positioning configuration for Timeline Layers
const tlConfig = {
...
const HeroDesktop = ({ onNavClick }: HeroDesktopProps) => {
    return (
        <div className="hidden md:block relative w-full pt-20 pb-8 px-6 sm:px-8 max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-10 items-center">
                ...
                <div className="relative w-full h-[520px] lg:h-[640px] rounded-2xl animate-fade-in animate-delay-300">
                    {/* LAYER 1: The Image (Scale Normal for Desktop) */}
                    ...
                    {/* LAYER 2: Timeline Elements (Desktop Scale) */}
