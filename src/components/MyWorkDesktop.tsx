...
interface MyWorkDesktopProps {
    portfolioRef: React.RefObject<HTMLDivElement>;
    smoothRotateX: MotionValue<number>;
    smoothScale: MotionValue<number>;
}

const MyWorkDesktop: React.FC<MyWorkDesktopProps> = ({
    portfolioRef,
    smoothRotateX,
    smoothScale,
}) => {
        ...
        <div className="hidden md:block">
            ...
            >
                <motion.div
                    ...
                    className="max-w-7xl mx-auto bg-black/90 backdrop-blur-xl rounded-3xl p-12 border border-white/20 ring-1 ring-white/10 will-change-transform"
                    transition={{ type: "spring", stiffness: 120, damping: 30 }}
                >
                    <h2 className="text-5xl font-bold text-zinc-100 mb-12 animate-fade-in-up">
                        My Work
                    </h2>
